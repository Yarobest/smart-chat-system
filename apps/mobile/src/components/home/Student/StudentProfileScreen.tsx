...
export default function StudentProfileScreen() {
  ...
  const { unreadCount, groupCount, messageCount } = useLiveThreads();
        ...
        >
          <View className="bg-[#102B57] px-4 pb-6 pt-6">
            <View className="items-center">
              ...
              <Text className="mt-1 text-sm text-slate-300">ID: {user?.studentId ?? user?.id ?? 'Not available'}</Text>
            ...
            <View className="mt-5 flex-row overflow-hidden rounded-2xl border border-white/15 bg-white/10">
              <View className="flex-1 items-center py-4">
                <Text className="text-xl font-extrabold text-white">0</Text>
                <Text className="text-sm text-slate-300">Courses</Text>
              </View>
              <View className="w-px bg-white/10" />
              <View className="flex-1 items-center py-4">
                <Text className="text-xl font-extrabold text-white">{messageCount}</Text>
