    ...
    <SafeAreaView className="flex-1 bg-[#051839]">
      ...
      <ScrollView className="flex-1 bg-[#F5F7FA]" contentContainerStyle={{ padding: 16, gap: 12 }}>
        ...
        {visible.map((assignment) => {
          ...
          return (
            <Pressable key={assignment.id} onPress={() => router.push(`/(student)/tasks/assignments/${assignment.id}` as any)} className="rounded-2xl border border-slate-200 bg-white p-4">
