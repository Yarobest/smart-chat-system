...
export default function LoginScreen() {
  ...
  const handleSignIn = () => {
    const isValid =
      studentId.trim() === DEFAULT_ID && password === DEFAULT_PASSWORD;
        ...
        >
          <View className="flex-1">
            ...
            >
              ...
              <Text allowFontScaling className="mt-2 text-sm text-white/70">
                Sign in to continue to Campus Chat
              </Text>
            </LinearGradient>
            ...
            <View className="-mt-3 flex-1 rounded-t-3xl bg-white px-6 pb-8 pt-7">
              ...
              <View className="my-5 flex-row items-center">
                ...
                <Text
                  allowFontScaling
                  className="mx-3 text-xs font-medium text-slate-400"
                >
                  OR
                </Text>
                <View className="h-px flex-1 bg-slate-200" />
