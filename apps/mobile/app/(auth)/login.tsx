...
export default function LoginScreen() {
  ...
  const handleSignIn = () => {
    const isValid = studentId.trim() === DEFAULT_ID && password === DEFAULT_PASSWORD;
        ...
        <ScrollView
          ...
          <View className="flex-1">
            <LinearGradient
              ...
              <Text allowFontScaling className="mt-2 text-sm text-white/70">Sign in to continue to Campus Chat</Text>
            </LinearGradient>

            <View className="-mt-3 flex-1 rounded-t-3xl bg-white px-6 pt-7 pb-8">
              <View className="mb-4">
              ...
              <View className="mb-6">
                ...
                <Pressable className="mt-3 self-end">
                  <Text allowFontScaling className="text-sm font-semibold text-blue-600">Forgot password?</Text>
                </Pressable>
              </View>
              ...
              <Pressable
                ...
                <Text allowFontScaling className="text-base font-bold text-white">Sign In</Text>
              </Pressable>

              <View className="my-5 flex-row items-center">
                <View className="h-px flex-1 bg-slate-200" />
                <Text allowFontScaling className="mx-3 text-xs font-medium text-slate-400">OR</Text>
                <View className="h-px flex-1 bg-slate-200" />
              </View>

              <Pressable className="items-center rounded-xl border border-slate-300 bg-white px-4 py-4 active:bg-slate-50">
                <Text allowFontScaling className="text-base font-semibold text-slate-700">
              ...
              <Pressable onPress={() => router.push('/Register')} className="mt-5">
                <Text allowFontScaling className="text-center text-sm text-slate-500">
                  New here? <Text allowFontScaling className="font-semibold text-blue-600">Create account</Text>
                </Text>
              </Pressable>
            </View>
          </View>
